...
class ControllerModuleContactMe extends Controller {
	...
	public function index() {
		...
		$this->data['entry_placing'] = $this->language->get('entry_placing');
		...
		if (isset($this->request->post[$this->_name . '_placing'])) {
			$this->data[$this->_name . '_placing'] = $this->request->post[$this->_name . '_placing'];
		} else {
			$this->data[$this->_name . '_placing'] = $this->config->get($this->_name . '_placing');
		}	
