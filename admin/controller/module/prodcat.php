...
class ControllerModuleProdcat extends Controller {
	...
	public function index() {   
		...
		$this->data['entry_sort_order'] = $this->language->get('entry_sort_order');
                $this->data['entry_lastlevelcategory'] = $this->language->get('entry_lastlevelcategory');
		$this->data['entry_column_count'] = $this->language->get('entry_column_count');
                $this->data['entry_tableparam'] = $this->language->get('entry_tableparam');
                $this->data['entry_trparam'] = $this->language->get('entry_trparam');
                $this->data['entry_tdparam'] = $this->language->get('entry_tdparam');
                $this->data['entry_aparam'] = $this->language->get('entry_aparam');

                $this->data['entry_selectcategories'] = $this->language->get('entry_selectcategories');
                $this->data['entry_heading_title'] = $this->language->get('entry_heading_title');
                $this->data['entry_heading_param'] = $this->language->get('entry_heading_param');
