        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr> 
            ...
            <td class="left"><select name="newslettersubscribe_module[<?php echo $module_row; ?>][position]">
                ...
                <!--
                <?php if ($module['position'] == 'newsletter_footer') { ?>
                <option value="newsletter_footer" selected="selected">Newsletter Footer</option>
                <?php } else { ?>
                <option value="newsletter_footer">Newsletter Footer</option>
                <?php } ?>
                -->

                <?php if ($module['position'] == 'content_slider') { ?>
                <option value="content_slider" selected="selected">Newsletter Footer</option>
                <?php } else { ?>
                <option value="content_slider">Newsletter Footer</option>
                <?php } ?>
...
function addModule() {	
    ...
    //html += '      <option value="newsletter_footer">Newsletter Footer</option>';

    html += '      <option value="content_slider">Newsletter Footer</option>';
