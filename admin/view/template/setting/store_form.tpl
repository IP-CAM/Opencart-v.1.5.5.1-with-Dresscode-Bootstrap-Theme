        ...
        <div id="tab-store">
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="config_template" onchange="$('#template').load('index.php?route=setting/store/template&token=<?php echo $token; ?>&template=' + encodeURIComponent(this.value)); warningOutput(this.value);">
