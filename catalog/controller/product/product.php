...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->data['az_button_cart'] = $this->language->get('az_button_cart');
            ...
            //dresscode constants
            $this->data['rollover_text'] = $this->language->get('rollover_text');
            $this->data['no_rating'] = $this->language->get('no_rating');
            ...
            $this->data['youtube_empty'] = $this->language->get('youtube_empty');
            ...
            $query = $this->db->query("SELECT youtube as video FROM ".DB_PREFIX."product WHERE product_id='".(int)$product_id."'");
			...
			foreach ($results as $result) {
                ...
                //related products youtube
                $this->data['youtubes_rel'] = array();
                $query_rel = $this->db->query("SELECT youtube as video FROM ".DB_PREFIX."product WHERE product_id='".(int)$result['product_id']."'");

                //$youtubes_rel = explode(',',$query_rel->row['video']);
                //$this->data['youtubes_rel'] = $youtubes_rel;
                //related products youtube
                ...
                $this->data['products'][] = array(
                    ...
                    //addit image
                    //youtube video
                    'youtube_video_rel' => $query_rel->row['video'],
