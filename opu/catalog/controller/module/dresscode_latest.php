...
class ControllerModuleDresscodeLatest extends Controller {
	protected function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/dresscode_latest.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/dresscode_latest.tpl';
		} else {
			$this->template = 'default/template/module/dresscode_latest.tpl';
		}
