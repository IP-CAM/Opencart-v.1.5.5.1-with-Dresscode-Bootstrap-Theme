...
$_['text_pagination']       = 'Showing <strong>{start}</strong> to <strong>{end}</strong> of <strong>{total}</strong> ({pages} Pages)';
$_['text_separator']        = '';
...
// addit vars
$_['text_original_products']      = 'ORIGINAL PRODUCTS';
$_['text_free_shipping']      = 'FREE SHIPPING';
$_['text_cash_delivery']      = 'CASH ON DELIVERY';
$_['text_day_returns']      = '30 DAY RETURNS';

$_['flash_title']      = 'TAGS';

$_['text_new_products']  = 'New Products';
$_['text_sale']          = 'ON SALE';
