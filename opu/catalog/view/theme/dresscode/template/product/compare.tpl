  ...
  <?php if ($products) { ?>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php if ($products[$product['product_id']]['price']) { ?>
          <?php if (!$products[$product['product_id']]['special']) { ?>
            <span class="price_normal"><?php echo $products[$product['product_id']]['price']; ?></span>
          <?php } else { ?>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
          <td><img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.gif" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
